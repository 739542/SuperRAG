...
def build_answer_generator_prompt(
    *,
    ...
    return (
        ...
        "Generation rules:\n"
        "- Answer the user's question directly before talking about the supporting documents.\n"
        "- Organize the answer around the asked object, scope, rule, or process, not around a raw list of retrieved files.\n"
        "- Treat the most relevant document as the primary basis when appropriate, and mention other documents only as supporting context.\n"
        "- When the user asks 'what does X include', summarize the major content categories, responsibilities, rules, and relationships of X.\n"
        "- Avoid template-like replies such as only listing 'relevant evidence includes ...' unless the evidence is truly too weak to answer.\n"
