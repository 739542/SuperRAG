...
(function () {
  ...
  function normalizeArtifactRecord(record = {}) {
    ...
    return {
      ...
      manualEdited: Boolean(record.manualEdited || record.manual_edited),
